...
<center> 
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><img src="img/<?php echo $row["image"]; ?> " style="width: 80px ; height: 80px ; border-radius: 5px" /></td>
        <td><?php echo $row["price"]; ?></td>
        <td> <?php echo $row["Type"]; ?></td>
        <td><?php echo $row["describe1"]; ?></td>
        <td><?php echo $row["material"]; ?></td>
        <td><a href="addproduct.php">Add</a> /<a href="editproduct.php?id=<?php echo $row["id"] ?>"> Edit </a>/ <a href='delproduct.php?id=<?php echo $row["id"] ?>' > Delete</a></td>
      </tr>
